.class public final Lcom/nothing/ear/two/control/ControlActivity;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/nothing/ear/two/control/ControlActivity$Companion;
    }
.end annotation
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;",
        ">;"
    }
.end annotation

.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nControlActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ControlActivity.kt\ncom/nothing/ear/two/control/ControlActivity\n+ 2 ActivityExt.kt\ncom/nothing/base/util/ext/ActivityExtKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 4 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,335:1\n321#2:336\n1#3:337\n1869#4,2:338\n*S KotlinDebug\n*F\n+ 1 ControlActivity.kt\ncom/nothing/ear/two/control/ControlActivity\n*L\n111#1:336\n212#1:338,2\n*E\n"
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/nothing/ear/two/control/ControlActivity;",
        "Lcom/nothing/base/view/BaseActivity;",
        "Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;",
        "<init>",
        "()V",
...
# static fields
.field public static final Companion:Lcom/nothing/ear/two/control/ControlActivity$Companion;
...
# direct methods
.method public static synthetic $r8$lambda$IpRUfmB-mgz6Q4Q5GXP2aOPLtMw()Lkotlin/Unit;
    .locals 1

    invoke-static {}, Lcom/nothing/ear/two/control/ControlActivity;->rightLabelClickEvent$lambda$1()Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$L_NAXMUosfyd0O890px2gKaCcwU(Lcom/nothing/ear/two/control/ControlActivity;Landroidx/activity/result/ActivityResult;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1}, Lcom/nothing/ear/two/control/ControlActivity;->onClickChangeData$lambda$5(Lcom/nothing/ear/two/control/ControlActivity;Landroidx/activity/result/ActivityResult;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$qrRt1RSeF13U9MxHzQUVRdGND3U(Lcom/nothing/ear/two/control/ControlActivity;)V
    .locals 0

    invoke-static {p0}, Lcom/nothing/ear/two/control/ControlActivity;->setDefaultScaleSelected$lambda$7$lambda$6(Lcom/nothing/ear/two/control/ControlActivity;)V

    return-void
.end method

.method public static synthetic $r8$lambda$rWeF9lPnifBz1sUSaym6hLA1u3U(Lcom/nothing/ear/two/control/ControlActivity;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0}, Lcom/nothing/ear/two/control/ControlActivity;->rightLabelClickEvent$lambda$0(Lcom/nothing/ear/two/control/ControlActivity;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$uGn0RbS_rlTc6-XTQi2sifQccL8()Lkotlin/Unit;
    .locals 1

    invoke-static {}, Lcom/nothing/ear/two/control/ControlActivity;->onSaveInstanceState$lambda$8()Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$vnM0gEzgoO57z7fJf5lk4ClIPOo(Lcom/nothing/ear/two/control/ControlActivity;Lkotlin/Pair;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1}, Lcom/nothing/ear/two/control/ControlActivity;->setDefaultScaleSelected$lambda$7(Lcom/nothing/ear/two/control/ControlActivity;Lkotlin/Pair;)Lkotlin/Unit;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/nothing/ear/two/control/ControlActivity$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/nothing/ear/two/control/ControlActivity$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/nothing/ear/two/control/ControlActivity;->Companion:Lcom/nothing/ear/two/control/ControlActivity$Companion;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->resetString:Ljava/lang/String;
...
.method private final checkValid()Z
    ...
    iget-wide v2, p0, Lcom/nothing/ear/two/control/ControlActivity;->clickTime:J
    ...
    iput-wide v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->clickTime:J
...
.method private final isLeft()Z
    ...
    .line 176
    invoke-virtual {p0}, Lcom/nothing/ear/two/control/ControlActivity;->getMBinding()Landroidx/databinding/ViewDataBinding;

    move-result-object v0

    check-cast v0, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;

    iget-object v0, v0, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivLeft:Landroidx/appcompat/widget/AppCompatImageView;
...
.method private final isRight()Z
    ...
    iget-object v0, v0, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivRight:Landroidx/appcompat/widget/AppCompatImageView;
...
.method private final onClickChangeData(Lcom/nothing/earbase/control/ControlGestureViewModel;)V
    ...
    const-class v2, Lcom/nothing/ear/two/control/ControlOperationActivity;
    ...
    invoke-direct {p0}, Lcom/nothing/ear/two/control/ControlActivity;->isLeft()Z
    ...
    .line 234
    invoke-virtual {p0}, Lcom/nothing/ear/two/control/ControlActivity;->getResultLauncher()Lcom/nothing/base/launcher/ActivityResultLauncher;

    move-result-object p1

    new-instance v1, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0}, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda1;-><init>(Lcom/nothing/ear/two/control/ControlActivity;)V
...
.method private static final onClickChangeData$lambda$5(Lcom/nothing/ear/two/control/ControlActivity;Landroidx/activity/result/ActivityResult;)Lkotlin/Unit;
    .locals 3
    ...
    .line 239
    iget-object p0, p0, Lcom/nothing/ear/two/control/ControlActivity;->viewModel:Lcom/nothing/ear/two/control/ControlViewModel;
    ...
    :goto_1
    invoke-virtual {v0, v1}, Lcom/nothing/ear/two/control/ControlViewModel;->getGestureData(Z)V
...
.method private final refreshGestureData(Lcom/nothing/ear/two/control/ControlViewModel;Z)V
    ...
    .line 211
    :goto_0
    iget-object v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->adapter:Lcom/nothing/earbase/control/ControlAdapter;
    ...
    invoke-virtual {p1}, Lcom/nothing/ear/two/control/ControlViewModel;->getSelectedItemViewModel()Landroidx/databinding/ObservableField;
    ...
    .line 216
    invoke-direct {p0, v0}, Lcom/nothing/ear/two/control/ControlActivity;->onClickChangeData(Lcom/nothing/earbase/control/ControlGestureViewModel;)V
...
.method private static final rightLabelClickEvent$lambda$0(Lcom/nothing/ear/two/control/ControlActivity;)Lkotlin/Unit;
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/nothing/ear/two/control/ControlViewModel;->resetGestureData()V
...
.method private final setDefaultScaleSelected()V
    ...
    .line 286
    invoke-virtual {p0}, Lcom/nothing/ear/two/control/ControlActivity;->getIntent()Landroid/content/Intent;
    ...
    check-cast v1, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;

    iget-object v1, v1, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivLeft:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    iget-object v1, v1, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivRight:Landroidx/appcompat/widget/AppCompatImageView;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/AppCompatImageView;->setAlpha(F)V

    .line 291
    iget-object v1, p0, Lcom/nothing/ear/two/control/ControlActivity;->viewModel:Lcom/nothing/ear/two/control/ControlViewModel;
    ...
    :cond_1
    invoke-virtual {v1}, Lcom/nothing/ear/two/control/ControlViewModel;->getLeftTextVisible()Landroidx/databinding/ObservableField;
    ...
    .line 298
    iget-object v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->viewModel:Lcom/nothing/ear/two/control/ControlViewModel;
    ...
    :cond_5
    invoke-virtual {v0}, Lcom/nothing/ear/two/control/ControlViewModel;->getRightTextVisible()Landroidx/databinding/ObservableField;
    ...
    :goto_1
    invoke-virtual {v5}, Lcom/nothing/ear/two/control/ControlViewModel;->getDataUpdate()Landroidx/lifecycle/MutableLiveData;
    ...
    new-instance v2, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda5;

    invoke-direct {v2, p0}, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda5;-><init>(Lcom/nothing/ear/two/control/ControlActivity;)V

    new-instance v3, Lcom/nothing/ear/two/control/ControlActivityKt$sam$androidx_lifecycle_Observer$0;

    invoke-direct {v3, v2}, Lcom/nothing/ear/two/control/ControlActivityKt$sam$androidx_lifecycle_Observer$0;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method private static final setDefaultScaleSelected$lambda$7(Lcom/nothing/ear/two/control/ControlActivity;Lkotlin/Pair;)Lkotlin/Unit;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lcom/nothing/ear/two/control/ControlActivity;->refreshGestureData(Lcom/nothing/ear/two/control/ControlViewModel;Z)V
    ...
    iget-object v0, v0, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->rvControl:Landroidx/recyclerview/widget/RecyclerView;

    new-instance v1, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0}, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda2;-><init>(Lcom/nothing/ear/two/control/ControlActivity;)V
    ...
    .line 314
    :cond_1
    invoke-direct {p0, p1}, Lcom/nothing/ear/two/control/ControlActivity;->showRightLabel(Lkotlin/Pair;)V
...
.method private static final setDefaultScaleSelected$lambda$7$lambda$6(Lcom/nothing/ear/two/control/ControlActivity;)V
    .locals 3
    ...
    .line 309
    :goto_0
    iget-object p0, p0, Lcom/nothing/ear/two/control/ControlActivity;->adapter:Lcom/nothing/earbase/control/ControlAdapter;
...
.method private final showRightLabel(Lkotlin/Pair;)V
    ...
    .line 169
    invoke-virtual {p0}, Lcom/nothing/ear/two/control/ControlActivity;->getActionBarBinding()Lcom/nothing/ear/databinding/BaseActionBarViewBinding;
    ...
    iget-object v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->resetString:Ljava/lang/String;
...
.method public afterOnSuperCreate()V
    ...
    invoke-virtual {p0, v0}, Lcom/nothing/ear/two/control/ControlActivity;->getString(I)Ljava/lang/String;
...
.method public beforeOnSuperCreate()V
    ...
    invoke-virtual {p0}, Lcom/nothing/ear/two/control/ControlActivity;->getWindow()Landroid/view/Window;
...
.method public createContentConfig(Lcom/nothing/base/view/BaseConfig;)V
    ...
    .line 111
    iput-object v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->viewModel:Lcom/nothing/ear/two/control/ControlViewModel;
    ...
    iput-object v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->resetDialog:Lcom/nothing/base/dialog/confirm/ConfirmMsgDialog;
    ...
    .line 128
    sget v6, Lcom/nothing/ear/R$layout;->ear_two_control_item:I
    ...
    iput-object v0, p0, Lcom/nothing/ear/two/control/ControlActivity;->adapter:Lcom/nothing/earbase/control/ControlAdapter;

    .line 135
    sget v0, Lcom/nothing/ear/R$layout;->ear_two_control_activity:I
    ...
    iget-object v3, p0, Lcom/nothing/ear/two/control/ControlActivity;->viewModel:Lcom/nothing/ear/two/control/ControlViewModel;
...
.method public final onClickItem(Lcom/nothing/ear/two/control/ControlItemViewModel;)V
    .locals 1
    ...
    invoke-direct {p0, p1}, Lcom/nothing/ear/two/control/ControlActivity;->onClickChangeData(Lcom/nothing/earbase/control/ControlGestureViewModel;)V
...
.method public final onClickLeft(Lcom/nothing/ear/two/control/ControlViewModel;)V
    ...
    .line 189
    invoke-direct {p0}, Lcom/nothing/ear/two/control/ControlActivity;->checkValid()Z
    ...
    check-cast v2, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;

    iget-object v2, v2, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivRight:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    check-cast v3, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;

    iget-object v3, v3, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->tvLeft:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    check-cast v4, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;

    iget-object v4, v4, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->tvRight:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {p0, v0, v2, v3, v4}, Lcom/nothing/ear/two/control/ControlActivity;->scaleSelectedView(Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/widget/TextView;)V

    .line 195
    :cond_1
    invoke-direct {p0, p1, v1}, Lcom/nothing/ear/two/control/ControlActivity;->refreshGestureData(Lcom/nothing/ear/two/control/ControlViewModel;Z)V
...
.method public final onClickRight(Lcom/nothing/ear/two/control/ControlViewModel;)V
    ...
    .line 203
    invoke-direct {p0}, Lcom/nothing/ear/two/control/ControlActivity;->isRight()Z
    ...
    iget-object v2, v2, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivLeft:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    iget-object v3, v3, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->tvRight:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v4, v4, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->tvLeft:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public onInit(Landroid/os/Bundle;)V
    ...
    .line 145
    invoke-direct {p0}, Lcom/nothing/ear/two/control/ControlActivity;->setDefaultScaleSelected()V
    ...
    check-cast p1, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;

    iget-object p1, p1, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivLeft:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    iget-object p1, p1, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->ivRight:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    iget-object p1, p1, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->rvControl:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {p1, p0}, Lcom/nothing/ear/databinding/EarTwoControlActivityBinding;->setEventHandler(Lcom/nothing/ear/two/control/ControlActivity;)V
...
.method public onInitStatusBar(Lcom/nothing/ear/databinding/BaseActivityBinding;)V
    ...
    invoke-virtual {p0}, Lcom/nothing/ear/two/control/ControlActivity;->getResources()Landroid/content/res/Resources;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    new-instance v1, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda0;-><init>()V
...
.method public rightLabelClickEvent()V
    ...
    iget-object v1, p0, Lcom/nothing/ear/two/control/ControlActivity;->resetString:Ljava/lang/String;
    ...
    .line 97
    iget-object v1, p0, Lcom/nothing/ear/two/control/ControlActivity;->resetDialog:Lcom/nothing/base/dialog/confirm/ConfirmMsgDialog;
    ...
    new-instance v3, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda3;

    invoke-direct {v3, p0}, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda3;-><init>(Lcom/nothing/ear/two/control/ControlActivity;)V

    new-instance v4, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda4;

    invoke-direct {v4}, Lcom/nothing/ear/two/control/ControlActivity$$ExternalSyntheticLambda4;-><init>()V
