.class public final Lcom/nothing/ear/two/core/api/EarTwoRepo;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/nothing/ear/two/core/api/EarTwoRepo;",
        "Lcom/nothing/network/core/NetworkRepoFactory;",
        "<init>",
        "()V",
        "apiService",
        "Lcom/nothing/ear/two/core/api/EarTwoApiService;",
        "getBaseUrl",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/nothing/ear/two/core/api/EarTwoRepo;


# direct methods
.method public static synthetic $r8$lambda$53sQ7WIINepEWVlaczjXNaAXYc4(B)Ljava/lang/CharSequence;
    .locals 0

    invoke-static {p0}, Lcom/nothing/ear/two/core/api/EarTwoRepo;->getAuth$lambda$1(B)Ljava/lang/CharSequence;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/nothing/ear/two/core/api/EarTwoRepo;

    invoke-direct {v0}, Lcom/nothing/ear/two/core/api/EarTwoRepo;-><init>()V

    sput-object v0, Lcom/nothing/ear/two/core/api/EarTwoRepo;->INSTANCE:Lcom/nothing/ear/two/core/api/EarTwoRepo;
...
.method public static final synthetic access$apiService(Lcom/nothing/ear/two/core/api/EarTwoRepo;)Lcom/nothing/ear/two/core/api/EarTwoApiService;
    .locals 0

    .line 17
    invoke-direct {p0}, Lcom/nothing/ear/two/core/api/EarTwoRepo;->apiService()Lcom/nothing/ear/two/core/api/EarTwoApiService;
...
.method public static final synthetic access$getAuth(Lcom/nothing/ear/two/core/api/EarTwoRepo;J)Ljava/lang/String;
    .locals 0

    .line 17
    invoke-direct {p0, p1, p2}, Lcom/nothing/ear/two/core/api/EarTwoRepo;->getAuth(J)Ljava/lang/String;
...
.method private final apiService()Lcom/nothing/ear/two/core/api/EarTwoApiService;
    .locals 4
    ...
    const-class v1, Lcom/nothing/ear/two/core/api/EarTwoApiService;
    ...
    check-cast v0, Lcom/nothing/ear/two/core/api/EarTwoApiService;
    ...
    const-string v1, "null cannot be cast to non-null type com.nothing.ear.two.core.api.EarTwoApiService"
...
.method private final getAuth(J)Ljava/lang/String;
    ...
    new-instance v7, Lcom/nothing/ear/two/core/api/EarTwoRepo$$ExternalSyntheticLambda0;

    invoke-direct {v7}, Lcom/nothing/ear/two/core/api/EarTwoRepo$$ExternalSyntheticLambda0;-><init>()V
...
.method public final clearMimiAnonymousId(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 42
    new-instance v0, Lcom/nothing/ear/two/core/api/EarTwoRepo$clearMimiAnonymousId$2;

    const/4 v1, 0x0

    invoke-direct {v0, p1, v1}, Lcom/nothing/ear/two/core/api/EarTwoRepo$clearMimiAnonymousId$2;-><init>(Ljava/lang/String;Lkotlin/coroutines/Continuation;)V

    check-cast v0, Lkotlin/jvm/functions/Function1;

    invoke-virtual {p0, v0, p2}, Lcom/nothing/ear/two/core/api/EarTwoRepo;->safeCall(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final getMimiAnonymousId(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 58
    new-instance v0, Lcom/nothing/ear/two/core/api/EarTwoRepo$getMimiAnonymousId$2;

    const/4 v1, 0x0

    invoke-direct {v0, p1, v1}, Lcom/nothing/ear/two/core/api/EarTwoRepo$getMimiAnonymousId$2;-><init>(Ljava/lang/String;Lkotlin/coroutines/Continuation;)V
...
.method public final refreshMimiAnonymousId(Ljava/lang/String;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1}, Lcom/nothing/ear/two/core/api/EarTwoRepo$refreshMimiAnonymousId$2;-><init>(Ljava/lang/String;Ljava/lang/String;Lkotlin/coroutines/Continuation;)V

    check-cast v0, Lkotlin/jvm/functions/Function1;

    invoke-virtual {p0, v0, p3}, Lcom/nothing/ear/two/core/api/EarTwoRepo;->safeCall(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
