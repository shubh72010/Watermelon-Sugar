.class public final Lcom/nothing/gligar/equalizer/EqualizerActivity;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;",
        ">;",
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/nothing/gligar/equalizer/EqualizerActivity;",
        "Lcom/nothing/base/view/BaseActivity;",
        "Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;",
        "Lcom/nothing/base/wiget/radar/OnEQChangeListener;",
        "<init>",
...
# instance fields
.field private viewModel:Lcom/nothing/gligar/equalizer/EqualizerViewModel;


# direct methods
.method public static synthetic $r8$lambda$cWpkG7qBmSBkacGrTSsRvxojvCs(Lcom/nothing/gligar/equalizer/EqualizerActivity;Ljava/util/List;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1}, Lcom/nothing/gligar/equalizer/EqualizerActivity;->onInitObserver$lambda$2(Lcom/nothing/gligar/equalizer/EqualizerActivity;Ljava/util/List;)Lkotlin/Unit;
...
.method private static final onInitObserver$lambda$2(Lcom/nothing/gligar/equalizer/EqualizerActivity;Ljava/util/List;)Lkotlin/Unit;
    .locals 0

    if-eqz p1, :cond_0

    .line 98
    invoke-virtual {p0}, Lcom/nothing/gligar/equalizer/EqualizerActivity;->getMBinding()Landroidx/databinding/ViewDataBinding;

    move-result-object p0

    check-cast p0, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;

    iget-object p0, p0, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->vRadar:Lcom/nothing/base/wiget/radar/EQDragView;
...
.method public createActionViewConfig(Lcom/nothing/base/view/ActionViewConfig;)V
    ...
    invoke-virtual {p0, v0}, Lcom/nothing/gligar/equalizer/EqualizerActivity;->getString(I)Ljava/lang/String;
...
.method public createContentConfig(Lcom/nothing/base/view/BaseConfig;)V
    ...
    const-class v0, Lcom/nothing/gligar/equalizer/EqualizerViewModel;

    invoke-virtual {v1, v0}, Landroidx/lifecycle/ViewModelProvider;->get(Ljava/lang/Class;)Landroidx/lifecycle/ViewModel;

    move-result-object v0

    check-cast v0, Lcom/nothing/gligar/equalizer/EqualizerViewModel;

    .line 39
    iput-object v0, p0, Lcom/nothing/gligar/equalizer/EqualizerActivity;->viewModel:Lcom/nothing/gligar/equalizer/EqualizerViewModel;
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/nothing/gligar/equalizer/EqualizerViewModel;->register()V
    ...
    iget-object v3, p0, Lcom/nothing/gligar/equalizer/EqualizerActivity;->viewModel:Lcom/nothing/gligar/equalizer/EqualizerViewModel;
...
.method public onChange(II)V
    ...
    .line 112
    iget-object p2, p0, Lcom/nothing/gligar/equalizer/EqualizerActivity;->viewModel:Lcom/nothing/gligar/equalizer/EqualizerViewModel;
    ...
    :cond_0
    invoke-virtual {p2, p1}, Lcom/nothing/gligar/equalizer/EqualizerViewModel;->setCustomEQ(I)V
...
.method public final onClickType(Lcom/nothing/earbase/equalizer/viewmodel/EqualizerTypeViewModel;)V
    ...
    check-cast v0, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;

    iget-object v0, v0, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->vRadar:Lcom/nothing/base/wiget/radar/EQDragView;
    ...
    .line 108
    :cond_0
    iget-object v0, p0, Lcom/nothing/gligar/equalizer/EqualizerActivity;->viewModel:Lcom/nothing/gligar/equalizer/EqualizerViewModel;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/nothing/gligar/equalizer/EqualizerViewModel;->setEQMode(Lcom/nothing/earbase/equalizer/viewmodel/EqualizerTypeViewModel;)V
...
.method public onInit(Landroid/os/Bundle;)V
    ...
    check-cast p1, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;

    iget-object p1, p1, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->vBottom:Landroid/view/View;
    ...
    check-cast v1, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;

    iget-object v1, v1, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->vBottom:Landroid/view/View;
    ...
    .line 66
    iget-object v1, p0, Lcom/nothing/gligar/equalizer/EqualizerActivity;->viewModel:Lcom/nothing/gligar/equalizer/EqualizerViewModel;
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/nothing/gligar/equalizer/EqualizerViewModel;->getEqualizerTypes()Ljava/util/ArrayList;
    ...
    .line 72
    :cond_3
    new-instance v1, Lcom/nothing/gligar/equalizer/EqualizerActivity$onInit$1;

    invoke-direct {v1, v4}, Lcom/nothing/gligar/equalizer/EqualizerActivity$onInit$1;-><init>(Lkotlin/jvm/internal/Ref$IntRef;)V
    ...
    iget-object v1, v1, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->rvSound:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v0, v0, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->rvSound:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p1, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->rvSound:Landroidx/recyclerview/widget/RecyclerView;
    ...
    .line 87
    sget v1, Lcom/nothing/ear/R$layout;->gligar_equalizer_item:I
    ...
    :goto_1
    invoke-virtual {v2}, Lcom/nothing/gligar/equalizer/EqualizerViewModel;->getEqualizerTypes()Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;->vRadar:Lcom/nothing/base/wiget/radar/EQDragView;
...
.method public bridge synthetic onInitObserver(Landroidx/databinding/ViewDataBinding;)V
    ...
    invoke-virtual {p0, p1}, Lcom/nothing/gligar/equalizer/EqualizerActivity;->onInitObserver(Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;)V

    return-void
.end method

.method public onInitObserver(Lcom/nothing/ear/databinding/GligarEqualizerActivityBinding;)V
    .locals 3
    ...
    .line 96
    iget-object p1, p0, Lcom/nothing/gligar/equalizer/EqualizerActivity;->viewModel:Lcom/nothing/gligar/equalizer/EqualizerViewModel;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/nothing/gligar/equalizer/EqualizerViewModel;->getCustomEqState()Landroidx/lifecycle/MutableLiveData;
    ...
    new-instance v1, Lcom/nothing/gligar/equalizer/EqualizerActivity$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Lcom/nothing/gligar/equalizer/EqualizerActivity$$ExternalSyntheticLambda0;-><init>(Lcom/nothing/gligar/equalizer/EqualizerActivity;)V

    new-instance v2, Lcom/nothing/gligar/equalizer/EqualizerActivityKt$sam$androidx_lifecycle_Observer$0;

    invoke-direct {v2, v1}, Lcom/nothing/gligar/equalizer/EqualizerActivityKt$sam$androidx_lifecycle_Observer$0;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method public onInitStatusBar(Lcom/nothing/ear/databinding/BaseActivityBinding;)V
    ...
    invoke-virtual {p0}, Lcom/nothing/gligar/equalizer/EqualizerActivity;->getResources()Landroid/content/res/Resources;
