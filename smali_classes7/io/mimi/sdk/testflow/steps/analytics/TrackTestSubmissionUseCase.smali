.class public final Lio/mimi/sdk/testflow/steps/analytics/TrackTestSubmissionUseCase;
.super Ljava/lang/Object;
.source "TrackTestSubmissionUseCase.kt"
...
.method public constructor <init>(Lio/mimi/sdk/testflow/activity/TestType;Lio/mimi/sdk/core/internal/analytics/AnalyticsService;)V
    ...
    .line 14
    iput-object p1, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestSubmissionUseCase;->testType:Lio/mimi/sdk/testflow/activity/TestType;

    .line 15
    iput-object p2, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestSubmissionUseCase;->analyticsService:Lio/mimi/sdk/core/internal/analytics/AnalyticsService;
...
.method public synthetic constructor <init>(Lio/mimi/sdk/testflow/activity/TestType;Lio/mimi/sdk/core/internal/analytics/AnalyticsService;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 13
    :cond_0
    invoke-direct {p0, p1, p2}, Lio/mimi/sdk/testflow/steps/analytics/TrackTestSubmissionUseCase;-><init>(Lio/mimi/sdk/testflow/activity/TestType;Lio/mimi/sdk/core/internal/analytics/AnalyticsService;)V
...
.method public final invoke()V
    ...
    .line 21
    iget-object v1, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestSubmissionUseCase;->testType:Lio/mimi/sdk/testflow/activity/TestType;
    ...
    .line 22
    new-instance v1, Lio/mimi/sdk/testflow/analytics/TestSubmissionTrackingEvent;

    const/4 v2, 0x0

    const/4 v3, 0x1

    invoke-direct {v1, v2, v0, v3, v2}, Lio/mimi/sdk/testflow/analytics/TestSubmissionTrackingEvent;-><init>(Ljava/lang/String;Ljava/util/Map;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 23
    iget-object v0, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestSubmissionUseCase;->analyticsService:Lio/mimi/sdk/core/internal/analytics/AnalyticsService;
