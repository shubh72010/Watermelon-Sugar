.class public final Lio/mimi/sdk/testflow/steps/analytics/TrackTestRunStartUseCase;
.super Ljava/lang/Object;
.source "TrackTestRunStartUseCase.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lio/mimi/sdk/testflow/steps/analytics/TrackTestRunStartUseCase;",
        "",
        "testType",
...
.method public constructor <init>(Lio/mimi/sdk/testflow/activity/TestType;Lio/mimi/sdk/core/internal/analytics/AnalyticsService;)V
    ...
    .line 18
    iput-object p1, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestRunStartUseCase;->testType:Lio/mimi/sdk/testflow/activity/TestType;

    .line 19
    iput-object p2, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestRunStartUseCase;->analyticsService:Lio/mimi/sdk/core/internal/analytics/AnalyticsService;
...
.method public synthetic constructor <init>(Lio/mimi/sdk/testflow/activity/TestType;Lio/mimi/sdk/core/internal/analytics/AnalyticsService;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 17
    :cond_0
    invoke-direct {p0, p1, p2}, Lio/mimi/sdk/testflow/steps/analytics/TrackTestRunStartUseCase;-><init>(Lio/mimi/sdk/testflow/activity/TestType;Lio/mimi/sdk/core/internal/analytics/AnalyticsService;)V
...
.method public final invoke(ILio/mimi/hte/EarSideType;)V
    ...
    .line 29
    invoke-static {p1, v2, v0, v1}, Lio/mimi/sdk/testflow/analytics/TrackingExtensionsKt;->withFrequency$default(Ljava/util/Map;IILjava/lang/Object;)Ljava/util/Map;
    ...
    .line 31
    iget-object p2, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestRunStartUseCase;->testType:Lio/mimi/sdk/testflow/activity/TestType;
    ...
    invoke-direct/range {v0 .. v5}, Lio/mimi/sdk/testflow/analytics/TestRunStartTrackingEvent;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 34
    iget-object p1, p0, Lio/mimi/sdk/testflow/steps/analytics/TrackTestRunStartUseCase;->analyticsService:Lio/mimi/sdk/core/internal/analytics/AnalyticsService;

    check-cast v0, Lio/mimi/sdk/core/internal/analytics/TrackingStartEvent;

    invoke-interface {p1, v0}, Lio/mimi/sdk/core/internal/analytics/AnalyticsService;->trackWithDuration(Lio/mimi/sdk/core/internal/analytics/TrackingStartEvent;)V
